    ...
    <header>
        ...
        <div class="header">
            <div class="row">
                ...
                <div class="col-1">
                    <a href="<?php echo base_url(); ?>index.php/header/index" class="header__index">
                        <p>Trang chủ</p>
                    </a>
                </div>
                <div class="col-1">
                    <a href="#" class="header__introduce">
                        <p>Giới thiệu</p>
                    </a>
                </div>
                <div class="col-1">
                ...
                <div class="col-2">
                    ...
                    <a href="#" class="icon__search"><i class="fa-solid fa-magnifying-glass"></i>
                    </a>
                    </div>
                </div>
               <div class="col-1">
                ...
                <div class="col-2">
                    <a href="<?php echo base_url(); ?>index.php/Auth/login" class="header__login">
                        <p>Đăng nhập </p>
                    </a>
                </div>
